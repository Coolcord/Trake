...
Menu::Menu(ALLEGRO_EVENT_QUEUE *event, float screen_width, float screen_height, float snake_width)
{
  ...
  m_game = NULL;
  m_title = new std::vector<Simple_Rectangle*>();
...
Menu::~Menu()
{
  for (std::vector<Simple_Rectangle*>::iterator iter = m_title->begin(); iter != m_title->end(); ++iter)
  {
    delete (*iter);
  }
  m_title->clear();
...
void Menu::show_control_setup(int player_num)
{
  ...
  while (true)
  {
    ...
    float y = m_screen_height/50;
	ss << player_num;
    std::string text = "Player " + ss.str() + " Controls";
    ALLEGRO_COLOR color;
    switch (player_num)
    {
      case 1:
...
void Menu::create_t(float x, float y)
{
  ...
  for (int i = 0; i < 5; i++)
  {
    m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y, m_title_snake_width, m_title_snake_width, false, color, m_thickness));
    if (i == 2) vertical_x = x+(i*m_title_snake_width);
  }
  //Finish with a vertical line
  for (int i = 1; i < 5; i++)
  {
    m_title->push_back(new Simple_Rectangle(vertical_x, y+(i*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  }
}
...
void Menu::create_r(float x, float y)
{
  ...
  for (int i = 0; i < 5; i++)
  {
    m_title->push_back(new Simple_Rectangle(x, y+(i*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  }
  //Draw the horizontal lines
  for (int i = 1; i < 3; i++)
  {
    m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y, m_title_snake_width, m_title_snake_width, false, color, m_thickness));
    if (i != 3) m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y+(2*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  }
  m_title->push_back(new Simple_Rectangle(x+(3*m_title_snake_width), y+(1*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(3*m_title_snake_width), y+(3*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(3*m_title_snake_width), y+(4*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
}
...
void Menu::create_a(float x, float y)
{
  ...
  {
    m_title->push_back(new Simple_Rectangle(x, y+(i*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
    m_title->push_back(new Simple_Rectangle(x+(3*m_title_snake_width), y+(i*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  }
  //Draw Horizontal Lines
  for (int i = 1; i < 3; i++)
  {
    m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y, m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y+(2*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  }
}
...
void Menu::create_k(float x, float y)
{
  ...
  m_title->push_back(new Simple_Rectangle(x+(1*m_title_snake_width), y+(2*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(2*m_title_snake_width), y+(1*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(2*m_title_snake_width), y+(3*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(3*m_title_snake_width), y, m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  m_title->push_back(new Simple_Rectangle(x+(3*m_title_snake_width), y+(4*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
...
void Menu::create_e(float x, float y)
{
  ...
  for (int i = 1; i < 3; i++)
  {
    m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y, m_title_snake_width, m_title_snake_width, false, color, m_thickness));
    m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y+(2*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
    m_title->push_back(new Simple_Rectangle(x+(i*m_title_snake_width), y+(4*m_title_snake_width), m_title_snake_width, m_title_snake_width, false, color, m_thickness));
  }
}
