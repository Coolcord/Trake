    ...
    if (e.type == ALLEGRO_EVENT_KEY_DOWN)
    {
      switch(controls->get_control(e.keyboard.keycode))
      {
        ...
        case Controls::PLAYER_3_LEFT:
          if (snakes[2] && !ai[2]) snakes[2]->change_direction(Direction::LEFT);
          break;
        case Controls::PLAYER_3_RIGHT:
          if (snakes[2] && !ai[2]) snakes[2]->change_direction(Direction::RIGHT);
          break;
        case Controls::PLAYER_3_DOWN:
          if (snakes[2] && !ai[2]) snakes[2]->change_direction(Direction::DOWN);
          break;
        case Controls::PLAYER_3_UP:
          if (snakes[2] && !ai[2]) snakes[2]->change_direction(Direction::UP);
          break;
        case Controls::PLAYER_4_LEFT:
          if (snakes[3] && !ai[3]) snakes[3]->change_direction(Direction::LEFT);
          break;
        case Controls::PLAYER_4_RIGHT:
          if (snakes[3] && !ai[3]) snakes[3]->change_direction(Direction::RIGHT);
          break;
        case Controls::PLAYER_4_DOWN:
          if (snakes[3] && !ai[3]) snakes[3]->change_direction(Direction::DOWN);
          break;
        case Controls::PLAYER_4_UP:
          if (snakes[3] && !ai[3]) snakes[3]->change_direction(Direction::UP);
          break;
        default:
          break;
      }
